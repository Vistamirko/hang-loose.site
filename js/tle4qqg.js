...
window.Typekit.config = {
  a: "9103613",
  c: [
    ".tk-condor-compressed",
    '"condor-compressed",sans-serif',
    ".tk-condor-condensed",
    '"condor-condensed",sans-serif',
  ],
  fi: [30283, 30288, 30298, 30300],
  fc: [
    {
      id: 30283,
      family: "condor-compressed",
      src: "https://use.typekit.net/af/fd907f/00000000000000003b9ae492/27/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "400",
        style: "normal",
        display: "swap",
    ...
    },
    {
      id: 30288,
      family: "condor-compressed",
      src: "https://use.typekit.net/af/adaeb8/00000000000000003b9ae497/27/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "700",
        style: "normal",
        display: "swap",
    ...
    {
      id: 30298,
      family: "condor-condensed",
      src: "https://use.typekit.net/af/f634ae/00000000000000003b9ae4a1/27/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "500",
        style: "normal",
        display: "swap",
    ...
    },
    {
      id: 30300,
      family: "condor-condensed",
      src: "https://use.typekit.net/af/a4a4e6/00000000000000003b9ae4a3/27/{format}{?primer,subset_id,fvd,v}",
      descriptors: {
        weight: "700",
        style: "normal",
        display: "swap",
  ...
  fn: ["condor-compressed", ["n4", "n7"], "condor-condensed", ["n5", "n7"]],
  hn: "use.typekit.net",
  ht: "tk",
  js: "1.19.2",
  kt: "tle4qqg",
...
/*{"k":"1.19.2","auto_updating":true,"last_published":"2019-04-14 20:29:01 UTC"}*/
(function (window, document, undefined) {
  ...
  var Ha = null,
    S =
      "00000000000000003b9b12ea 00000000000000003b9b12ed 00000000000000003b9b12ef 00000000000000003b9b12f0 00000000000000003b9b12f2 00000000000000003b9b12f3".split(
        " "
      );
  function Ia() {
    null === Ha &&
